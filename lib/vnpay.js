...
export function createPaymentUrl(params) {
  ...
  // Create sign data with URL encoding (following VNPAY documentation)
  // According to VNPAY docs, we need to urlencode both keys and values for signature
  ...
  // Build payment URL with encoding (following VNPAY documentation)
...
export function verifyReturnUrl(vnpParams) {
  ...
  // Use URL encoding for signature verification (following VNPAY documentation)
